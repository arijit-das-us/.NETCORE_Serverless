...
namespace FSTGenericDataImport
{

    public static class Function1
    {
        [FunctionName("CopyGenericFSTData")]
            ...
            try
            {
                ...
                do
                {
                    ...
                    foreach (var blob in blobs)
                    {
                        ...
                        var sDestination = "Post_OptS11_FST/Summary/" + block.Name.Replace(".csv", ".json");
